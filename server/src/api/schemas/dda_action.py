...
class DDAActionBase(BaseModel):
    """DDA 액션 기본 스키마"""

    session_id: str = Field(..., description="세션 ID")
    action_type: str = Field(..., description="DDA 액션 타입")
    parameters: str = Field(..., description="DDA 파라미터 (JSON 문자열)")


class DDAActionCreate(DDAActionBase):
    """DDA 액션 생성 요청 스키마"""

    pass


class DDAActionResponse(DDAActionBase):
    """DDA 액션 응답 스키마"""
